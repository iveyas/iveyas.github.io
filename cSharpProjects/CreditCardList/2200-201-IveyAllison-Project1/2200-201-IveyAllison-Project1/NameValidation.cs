    ...
    public class InputValidation
    {
        ...
        public Boolean CreditCardValidation(String CreditCardNumber)
        {
            ...
            try
            {
                ...
                LeadingNumbers = (LeadingNum = (Int64.Parse(CreditCardNumber))/10).ToString();
                ...
                CheckSum = CreditCardNumber[CreditCardNumber.Length - 1];
                long SumOfNumbersAndCheckSum = (long.Parse(CheckSum.ToString())) + SumOfNumbers +
                                               SumOfNonMultipliedNumbers;

                if (CreditCardNumber.Length <= 19 && CreditCardNumber.Length >= 12)
                {
                    Valid = true;
                }
                else
                ...
                if (System.Text.RegularExpressions.Regex.IsMatch(CreditCardNumber, pattern) == true && Valid == true)
                {
                    Valid = true;
                }
                else
            ...
            String CreditCardType = this.CreditCardType(CreditCardNumber, Valid);
            return Valid;
        }
